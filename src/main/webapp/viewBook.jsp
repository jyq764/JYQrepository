		...
		<div class="container5">
	    	<div class="cn5_top">
	            <div class="cn5_top_x center01">
	                ...
	                <a href="/JD03_estore/index.jsp">${applicationScope.book.description}</a>
	            </div>
	            <div class="cn5_top_y center01">
	            	<div class="cn5topy_1">
	                	<div class="cn5topy_imgview">
	                    	<img src="images/bookcover/${applicationScope.book.name}.jpg"/>
	                ...
	                <div class="cn5topy_2">
	                	...
	                	<h1 class="pro_title font15">${applicationScope.book.name}</h1>
	                    <div class="pro_price">
	                            <div class="pro_price_x">
	                                <p> 单价：<b>￥${applicationScope.book.price}</b> <a href="#">(降价通知)</a></p>
	                            </div>	
	                    </div>
	                    <!-- <div>
	                        <ul>
	                    ...
	                    <div class="pro_selects">
	                    	<div class="pro_select">
	                            ...
	                            <ul class="pro_select_vals">
	                                <li>${applicationScope.book.author}</li>
	                        ...
	                        <div class="pro_select">
	                            ...
	                            <ul class="pro_select_vals">
	                                <li>${applicationScope.book.publisher}</li>
	                        ...
	                        <div class="pro_select">
	                            ...
	                            <ul class="pro_select_vals">
	                                <li> 出版时间：<fmt:formatDate value="${applicationScope.book.pubdate}" pattern="yyyy-mm-dd"/></li>
	                                <li>包装：平装</li>
	                                <li>正文语种：中文</li>
	                            </ul>
	                        </div>
	                    </div>
					<form action="/JD03_estore/after/addCar" id="addCar">
	                    <div class="pro_buy">
	                    	<div class="pro_buy_nums">
	                    		<input type="hidden" value="${applicationScope.book.id}" name="id">
	                ...
	                <!--内容-->
	              	<div class="c5_b2_right_1 box">
	                        <div class="introduce_item">
	                          <ul>
	                        	<li>商品名称：${applicationScope.book.name}</li>
	                            <li>商品编号：${applicationScope.book.id}</li>
	                            <li class="fr"><a class="color_link1" href="#">更多参数>></a></li>
	                          </ul>
	                        </div>
	               		</div>
	                    <div class="intro_pics">
	                    	<img class="intro_pic" src="images/bookcover/${applicationScope.book.name}.jpg">
	                    </div>
	                </div>
