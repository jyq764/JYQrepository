...
<html lang="en">
	...
	<body>
	    ...
	    <div class="content">
			...
			<form action="/JD03_estore/after/orderlist" name="orderForm">
	    		...
	    		<div class="centerTop">
	    			...
	    			<ul class="adres">
	    				<c:choose>
	    					<c:when test="${empty sessionScope.addresscus.address}">
	    						<li>请添加收货地址</li>
	    					</c:when>
	    					<c:otherwise>
								<c:forEach items="${sessionScope.addresscus.address}" var="add">
						    		<li>
						    			<input type="radio" name="addressId" value="${add.id}" checked="checked" style="width:50px">
	    		...
	    		<p class="singleP"><b>送货清单</b><span><a href="/JD03_estore/after/shopCart.jsp">返回修改购物车</a></span></p>
	    		<div class="bigDiv">
	    			<div class="twoDiv">
	    				<b>商家：briup自营</b>
	    				<c:forEach items="${sessionScope.cart.lines}" var="ol" varStatus="status">
							<ul class="oneUL">
		    					<li>
		    						<img src="images/bookcover/${ol.book.name}.jpg" width="80px" height="100px" class="pic">
		    						<p>${ol.book.description}&nbsp;&nbsp;&nbsp;&nbsp;${ol.book.author}&nbsp;&nbsp;&nbsp;&nbsp;${ol.book.name}</p>
		    						<p><font>¥${ol.book.price}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${ol.num}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
	    		...
	    		<div class="money">
	    			<span><font>${sessionScope.cart.size}</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.cart.cost}元</span>
	    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>
	
	    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${sessionScope.cart.cost}元</span>
	    		</div>
	    		<div class="submit">
	    			<span>应付金额：<font>¥${sessionScope.cart.cost}元</font><input type="image" src="images/21_03.png"></span>
	    		</div>
				</form>
	    	</div>
